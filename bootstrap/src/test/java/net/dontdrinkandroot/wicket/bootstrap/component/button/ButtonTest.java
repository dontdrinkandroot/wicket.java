...
public class ButtonTest extends AbstractWicketTest
{
    ...
    public void testMarkup()
    {
        ...
        Assert.assertEquals(
                "<wicket:container wicket:id=\"id\" onclick=\"var win = this.ownerDocument.defaultView || this.ownerDocument.parentWindow; if (win == window) { window.location.href=&#039;./wicket/page?0-0.-id&#039;; } ;return false\" class=\"btn btn-default\">Label</wicket:container>",
                componentMarkup
        );
    }
}
