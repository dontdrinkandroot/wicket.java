...
public abstract class FormGroupNonInput<T, F extends FormComponent<T>> extends FormGroupFormComponent<T, F>
{
	...
	public FormGroupNonInput(String id, IModel<String> labelModel, IModel<T> model)
	{
		this(id, labelModel, model, null);
	}

	public FormGroupNonInput(String id, IModel<String> labelModel, IModel<T> model, Class<T> type)
	{
