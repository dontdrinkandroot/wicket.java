...
enum class FontAwesome4IconClass(override val classString: String, val description: String, val sinceVersion: String) :
    CssClass {
    ...
    fun createIcon(): FontAwesome4Icon = FontAwesome4Icon(this)
}